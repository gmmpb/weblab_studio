      ...
      <Highlighter className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 group [&_*:nth-child(n+5):not(:nth-child(n+12))]:order-1 [&_*:nth-child(n+10):not(:nth-child(n+11))]:!order-2">
        ...
        <div className="flex flex-col items-center justify-center text-center p-4">
          <p className="font-medium bg-clip-text text-transparent bg-gradient-to-r from-green-200/60 via-green-600 to-green-200/60 pb-3">
            <span className="line-clamp-6">
              Egyedi igényekre szabott, skálázható és biztonságos webes
              alkalmazásokat fejlesztünk, amelyeket ügyfeleink hosszú távon
              értékelnek. Büszkék vagyunk az elégedett partnereinkre, akik
              digitális jelenlétüket velünk építették.
            </span>
          </p>
        </div>
        {/* Testimonial #02 */}
        <div className="flex flex-col items-center justify-center text-center p-4">
          <p className="font-medium bg-clip-text text-transparent bg-gradient-to-r from-green-200/60 via-green-500 to-green-200/60 pb-3">
            <span className="line-clamp-6">
              Webfejlesztő csapatunk olyan megoldásokat hoz létre, amelyek
              ügyfeleink üzleti céljait támogatják, a felhasználói élményt
              helyezve előtérbe. Referenciáink között megtalálható a modern
              technológia, a funkcionalitás és a dizájn tökéletes harmóniája
              együttesen.
            </span>
          </p>
        </div>
