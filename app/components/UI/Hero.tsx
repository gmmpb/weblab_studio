...
const textContent: { [key: string]: any } = {
  en: {
    ...
    phonePlaceholder: "Example:+36 1 234 567",
    emailLabel: "Email Address",
    emailPlaceholder: "hello@weblabstudio.hu",
  ...
  hu: {
    ...
    description:
      "Üdvözöljük weboldalunkon! Mi egy professzionális weboldalkészítéssel foglalkozó csapat vagyunk, amelynek célja, hogy ügyfeleink online jelenlétét magasabb szintre emelje. Szakterületünk a modern, felhasználóbarát és reszponzív weboldalak tervezése és fejlesztése, amelyek nemcsak esztétikailag kiemelkedőek, hanem üzleti céljainak is hatékonyan megfelelnek. Az évek során számos projektet valósítottunk meg különféle iparágakban, ezért rendelkezünk azzal a tapasztalattal és szakértelemmel, amely lehetővé teszi számunkra, hogy pontosan az Ön igényeire szabott megoldást hozzunk létre. Az alapos piackutatástól kezdve, a modern design és fejlesztési trendek alkalmazásán keresztül, egészen a weboldalak folyamatos karbantartásáig, minden egyes lépésben az Ön vállalkozása sikerére összpontosítunk. Ha Ön is szeretné, hogy weboldala professzionális, látványos és célzott megoldásokkal erősítse márkáját, keressen minket bizalommal! Számunkra az ügyfeleink elégedettsége a legfontosabb, és mindig törekszünk arra, hogy túlszárnyaljuk az elvárásaikat. Lépjen velünk kapcsolatba, és valósítsuk meg együtt az Ön elképzeléseit!",
    ...
    phonePlaceholder: "Példa:+36 1 234 567",
    emailLabel: "E-mail cím",
    emailPlaceholder: "hello@weblabstudio.hu",
    messageLabel: "Üzenet",
    messagePlaceholder:
      "Üdv! Egy különleges webes élményt szeretnénk létrehozni. Tudnátok segíteni, hogy életre keljen az elképzelésünk? Beszéljünk a közös munkáról!",
